# Lab 4 - WXCP_ParseChat
WXCP_ParseChat is a Chat app using an [open source Parse](http://parseplatform.org/) backend.
...
- [x] current user has username in the title
- [x] current user has own chat bubble background color

Please list two areas of the assignment you'd like to **discuss further with your peers** during the next class (examples include better ways to implement something, how to extend your app in certain ways, etc):

1. Shift messages and username to the right for message sent by current user
2. have the message input field follow the keyboard
...
I need to read documentation more slowly and carefully
